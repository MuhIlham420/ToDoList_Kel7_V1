...
Write-Host "  DeepWork Sirkadian ToDoList - SQLite Demo" -ForegroundColor Cyan
Write-Host "  ================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "[1/3] Menyiapkan SQLite dan migrasi..." -ForegroundColor Yellow
...
Write-Host "[2/3] Menjalankan Laravel Backend API (port 8000)..." -ForegroundColor Yellow
...
Write-Host "[3/3] Menjalankan Vite Frontend (port 5173)..." -ForegroundColor Yellow
Start-Process -FilePath "powershell.exe" `
    -ArgumentList "-NoExit -Command `"cd '$frontendPath'; & '$npmPath' run dev`"" `
    -WindowStyle Minimized
Start-Sleep -Seconds 4
Write-Host "      Frontend berjalan di http://localhost:5173/ToDoList_Kel7_V1/" -ForegroundColor Green

Write-Host ""
Write-Host "  ================================================" -ForegroundColor Cyan
Write-Host "  Semua service berhasil dijalankan tanpa MySQL." -ForegroundColor Cyan
Write-Host ""
Write-Host "  Buka di browser:" -ForegroundColor White
Write-Host "  http://localhost:5173/ToDoList_Kel7_V1/" -ForegroundColor Green
Write-Host ""
...
Start-Process "http://localhost:5173/ToDoList_Kel7_V1/"
